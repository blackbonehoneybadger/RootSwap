...
ALLOWED_TRANSITIONS: dict[OrderStatus, set[OrderStatus]] = {
    ...
    OrderStatus.QUOTE_CONFIRMED: {OrderStatus.AWAITING_PAYMENT, OrderStatus.CANCELLED, OrderStatus.FAILED},
    ...
    OrderStatus.PAYMENT_CONFIRMING: {OrderStatus.PROCESSING, OrderStatus.DISPUTED, OrderStatus.FAILED},
    OrderStatus.PROCESSING: {OrderStatus.PAYOUT_SENT, OrderStatus.FAILED, OrderStatus.DISPUTED},
    ...
    OrderStatus.DISPUTED: {OrderStatus.PROCESSING, OrderStatus.REFUND_REQUESTED, OrderStatus.CANCELLED},
}
